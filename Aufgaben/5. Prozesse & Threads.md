...
## Threads
#### *Was sind Threads?*
Ein Thread ist eine einzelne Sequenz in einem Prozess, es wird auch lightweight process genannt, da es kleiner und schneller ist als ein Prozess. Threads haben keinen einheitlichen Lebenszyklus, da sie in jeder Programmiersprache anders implementiert.
